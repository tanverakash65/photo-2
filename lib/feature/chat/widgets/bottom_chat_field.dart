...
import 'package:photon/feature/chat/widgets/message_reply_preview.dart';
...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  void selectGIF() async {
    ...
    if (gif != null && gif.url != null) { // ✅ Fixed: Added null check for gif.url
      ref.read(chatControllerProvider).sendGIFMessage(
        context,
        gif.url!, // ✅ Fixed: Use ! to assert non-null
        widget.recieverUserId,
        widget.isGroupChat,
      );
    } else {
      showSnackbar(context: context, content: 'Failed to select GIF');
    }
  }
