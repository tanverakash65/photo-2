...
import 'package:photon/feature/chat/widgets/display_text_image_gif.dart';
...
class SenderMessageCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SwipeTo(
      onRightSwipe: (details) { // ✅ Fixed: Added parameter
        onRightSwipe();
      },
      child: Align(
                      ...
                      if (isReplying) ...[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: backgroundColor.withAlpha(128), // ✅ Fixed: Use withAlpha
